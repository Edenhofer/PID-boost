...
The described effect can be seen for every particle with an ID and is not limited to the pion. However, the comparison of the pion identification is a rather conservative choice as the legacy PID approach favors high abundance particles and should have put it at an advantage. The identification of particle species like the electron or muon performs consistently better using the new approach even at false positive rates above $50\%$.
