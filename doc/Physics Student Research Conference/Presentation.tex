...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.45\textheight,keepaspectratio]{{{../res/Sample Receiver Operating Characteristic (ROC) curve}}}
		\caption{Sample Receiver Operating Characteristic (ROC) curve.}
	\end{figure}

	\textbf{Idea:} \\
	Goodness of a selection via `True Positive Rate / False Positive Rate'
\end{frame}
