		...
		\begin{column}{0.47\textwidth}
			\begin{table}
				\begin{tabular}{l|l}
					...
					kaonID & $\mathcal{L}_{\mathrm{K}} / (\mathcal{L}_{\mathrm{K}} +\mathcolorbox{yellow}{\mathcal{L}_{\pi}})$ \\
					protonID & $\mathcal{L}_{\mathrm{p}} / (\mathcal{L}_{\mathrm{p}} +\mathcolorbox{yellow}{\mathcal{L}_{\pi}})$ \\
					...
					deuteronID & $\mathcal{L}_{\mathrm{d}} / (\mathcal{L}_{\mathrm{d}} +\mathcolorbox{yellow}{\mathcal{L}_{\pi}})$
				\end{tabular}
