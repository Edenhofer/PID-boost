...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{{{../res/charged 01/pidProbability Approach: Heatmap of epsilonPID Matrix for an exclusive Cut}}}
		\caption{Heatmaps of row-wised normed confusion matrices for an exclusive cut on the pidProbability.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.6\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: pi pidPropability multi-axes Histogram of pt, cosTheta above 0.05 Threshold}}}
		\caption{Multi-axes Histogram for the $\pi$-pidPropability above a 0.05 threshold as scatter plot depending on $p_t$ and $cos(\Theta)$.}
	\end{figure}
\end{frame}
