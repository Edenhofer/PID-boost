...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the `ALL' detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{Relative $K$ Abundance in Likelihood Ratio Bins for the `ALL' detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for SVD detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the SVD detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for CDC detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the CDC detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for TOP detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the TOP detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for ARICH detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the ARICH detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for ECL detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the ECL detector.}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{{{../res/charged 01/General Purpose Statistics: Relative pi Abundance in Likelihood Ratio Bins for KLM detector}}}
		\caption{Relative $\pi$ Abundance in Likelihood Ratio Bins for the KLM detector.}
	\end{figure}
\end{frame}
