...
\begin{frame}
	...
	\centering
	\includegraphics[height=0.65\textheight]{res/01-K+ identification (via ID).pdf}
\end{frame}
...
\begin{frame}
	...
	\centering
	\includegraphics[height=0.7\textheight]{res/01-epsilonPID-matrix (via ID).pdf}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}[T]
		\begin{column}{.5\textwidth}
			...
			\includegraphics[width=1\linewidth]{res/01-K+ identification (via ID).pdf}
		\end{column}
		\begin{column}{.5\textwidth}
			\centering Bayesian Approach
			\includegraphics[width=1\linewidth]{res/01-K+ identification (via bayes).pdf}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{minipage}[c][0.4\textheight][c]{\linewidth}
			\centering
			\includegraphics[width=0.8\linewidth]{res/01-pi+ identification (via ID).pdf}
		\end{minipage}
		\begin{minipage}[c][0.4\textheight][c]{\linewidth}
			\centering
			\includegraphics[width=0.8\linewidth]{res/01-mu+ identification (via ID).pdf}
		\end{minipage}

		\column{0.5\textwidth}
		\begin{minipage}[c][0.4\textheight][c]{\linewidth}
			\centering
			\includegraphics[width=0.8\linewidth]{res/01-pi+ identification (via bayes).pdf}
		\end{minipage}
		\begin{minipage}[c][0.4\textheight][c]{\linewidth}
			\centering
			\includegraphics[width=0.8\linewidth]{res/01-mu+ identification (via bayes).pdf}
		\end{minipage}
	\end{columns}
\end{frame}
