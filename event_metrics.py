...
if args.diff_methods:
    ...
    data.plot_diff_stats(stats_approaches=stats_approaches, x_axis=('fpr', 'False Positive Rate'), y_multi_axis=[('tpr', 'TPR')], x_lim=(None, None), title_suffixes=title_suffixes, particles_of_interest=particles_of_interest, savefig_prefix='Diff Statistics: ', savefig_suffix=' TPR over FPR (without Ratios)' + savefig_suffix, ratios=False)
    data.plot_diff_stats(stats_approaches=stats_approaches, x_axis=('fpr', 'False Positive Rate'), y_multi_axis=[('ppv', 'PPV')], x_lim=(None, None), title_suffixes=title_suffixes, particles_of_interest=particles_of_interest, savefig_prefix='Diff Statistics: ', savefig_suffix=' PPV over FPR (without Ratios)' + savefig_suffix, ratios=False)
    data.plot_diff_stats(stats_approaches=stats_approaches, x_axis=('tpr', 'Efficiency'), y_multi_axis=[('ppv', 'Purity')], x_lim=(None, None), title_suffixes=title_suffixes, particles_of_interest=particles_of_interest, savefig_prefix='Diff Statistics: ', savefig_suffix=' PPV over TPR' +  savefig_suffix)
    data.plot_diff_stats(stats_approaches=stats_approaches, x_axis=('tpr', 'Efficiency'), y_multi_axis=[('ppv', 'Purity')], x_lim=(None, None), title_suffixes=title_suffixes, particles_of_interest=particles_of_interest, savefig_prefix='Diff Statistics: ', savefig_suffix=' PPV over TPR (without Ratios)' + savefig_suffix, ratios=False)
